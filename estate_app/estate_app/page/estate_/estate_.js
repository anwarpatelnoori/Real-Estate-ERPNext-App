...
MyPage = Class.extend({
	...
	make:function(){
		...
		let total = function(){
			frappe.call({
				method:"estate_app.estate_app.page.estate_.estate_.get_total_price",
				callback: function(r){
		...
		let sale = ()=>{
			frappe.call({
				method:"estate_app.estate_app.page.estate_.estate_.get_total_sale",
				callback: function(r){
		...
		let rent = ()=>{
			frappe.call({
				method:"estate_app.estate_app.page.estate_.estate_.get_total_rent",
				callback: function(r){
		...
		let lease = ()=>{
			frappe.call({
				method:"estate_app.estate_app.page.estate_.estate_.get_total_lease",
				callback: function(r){
		...
		let status = function(){
			frappe.call({
				method:"estate_app.estate_app.page.estate_.estate_.get_property_price_by_status",
				callback: function(r){
